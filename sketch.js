...
function preload() {
  ...
  imgCreditos1=loadImage('creditos1.png');
...
if(tela==3){
  ...
  text('CRÉDITOS',50,50);
  text('BACK',68,375);
  image(imgCreditos,100,60);
  image(imgCreditos1,320,60);
  textSize(14);
  text('ORIENTADOR\n'+'Valério Gutemberg de Medeiros Júnior\n'+'Docente no Instituto Federal do Rio Grande do Norte(IFRN)',100,265, 200,350);
  text('DESENVOLVEDORA\n'+'Jéssica Aparecida Silva Costa\n'+'Discente da ECT, na Universidade Federaldo Rio Grande do Norte(UFRN)',320,265, 200,350);
   if(mouseX>50 && mouseX<130 && mouseY>350 && mouseY<385){
  rect(54,350,80,35);
  if (mouseIsPressed){
  soundMenu.play();  
